    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etHora.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(Agendar.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        btnAgendarSesion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (spinnerAlumnos.getSelectedItem() == null) {
                    Toast.makeText(Agendar.this, "Cargando alumnos...", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (tema.isEmpty() || objetivo.isEmpty() || hora.isEmpty()) {
                    Toast.makeText(Agendar.this, "Por favor completa todos los campos y la hora", Toast.LENGTH_SHORT).show();
                    return;
                }
